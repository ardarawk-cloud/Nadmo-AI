(()=>{
  ...
  if(typeof settings==='function'){
    ...
    settings=async function(){
      ...
      <div class="card release-card"><div class="release-row"><div><div class="release-name">NADMO AI</div><div class="privacy-note">Personal finance intelligence dengan data utama tersimpan lokal di perangkat.</div></div><div class="release-version">v1.4.0</div></div></div>`;
  ...
  document.documentElement.dataset.nadmoEdition='premium-v14';
